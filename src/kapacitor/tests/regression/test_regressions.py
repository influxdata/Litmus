...
class TestKapacitorRegressions(object):
    ...
    def test_del_db_sending_data_to_kapacitor(self):
        ...
        second_data_to_write= [{'measurement': 'test','tags':
            {'host': 'server01','region': 'us-west'},
            'fields': {'f1': 'This is a second data to write',}}]
        final_data_to_write= [{'measurement': 'test','tags':
            {'host': 'server01','region': 'us-west'},
            'fields': {'f1': 'This is a final data to write',}}]
        ...
        assert field_value_1 in value[0]['values'], \
