...
class TestSources():
    ...
    def test_update_source_name_field(self):
        ...
        response=self.rl.patch_source(self.chronograf, source_url, JSON_UPDATED_NAME, source_id)
    ...
    def test_delete_source(self):
        ...
        response=self.rl.delete_source(self.chronograf, source_url, source_id)
