...
class TestCreateUsersAPI(object):
    '''
    remove existing users before running tests
    '''
    ...
    def test_create_users_10_char_lower_case(self, ten_char):
        ...
        REST API: http://<gateway>/v1/users
        METHOD: POST
        tests user name containing 10 lower case characters can be created and persisted in the etcd store.
        '''
    ...
    def test_create_users_20_char_lower_case(self, twenty_char):
        ...
        REST API: http://<gateway>/v1/users
        METHOD: POST
        tests user name containing 20 lower case characters can be created and persisted in the etcd store.
        '''
    ...
    def test_create_users_10_char_upper_case(self, ten_char):
        ...
        REST API: http://<gateway>/v1/users
        METHOD: POST
        tests user name containing 10 upper case characters can be created and persisted in the etcd store.
        '''
    ...
    def test_create_users_10_digits(self, ten_char):
        ...
        REST API: http://<gateway>/v1/users
        METHOD: POST
        tests user name containing 10 digits can be created and persisted in the etcd store.
        '''
    ...
    def test_create_users_5_digits(self, five_char):
        ...
        REST API: http://<gateway>/v1/users
        METHOD: POST
        tests user name containing 20 digits can be created and persisted in the etcd store.
        '''
    ...
    def test_create_users_10_nonalphanumeric_char(self, ten_char):
        ...
        REST API: http://<gateway>/v1/users
        METHOD: POST
        tests user name containing 10 non-alphanumeric character can be created and persisted in the etcd store.
        '''
    ...
    def test_create_users_20_nonalphanumeric_char(self, twenty_char):
        ...
        REST API: http://<gateway>/v1/users
        METHOD: POST
        tests user name containing 20 non-alphanumeric characters can be created and persisted in the etcd store.
        '''
