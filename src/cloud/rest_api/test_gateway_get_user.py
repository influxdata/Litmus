...
class TestGetUsersAPI(object):
    '''
    Test Suite for testing RESTZ API endpoint for getting single user by id
    ...
    def test_get_non_existent_user_id(self):
        ...
        (status, actual_user_id, actual_user_name, error_message)=gateway_util.get_user_by_id(self, self.gateway, user_id)
